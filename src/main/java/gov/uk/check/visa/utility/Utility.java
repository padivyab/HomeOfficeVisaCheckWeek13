...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "src/main/java/gov/uk/check/visa/logs/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "src/main/java/gov/uk/check/visa/logs/screenshots/" + screenshotName + dateName + ".png";
    ...
    public void acceptCookiesAndSwitchToIframe() {
       ...
       // Thread.sleep(500);
        WebElement acceptCookies = driver.findElement(By.xpath("//div[@id='global-cookie-message']/div[1]/div[1]/div[2]/button[1]"));
        acceptCookies.click();

    }
   /* public void clickpage()
    {
        WebElement clickP = driver.findElement(By.xpath("//div[@class='gem-c-feedback__prompt gem-c-feedback__js-show js-prompt']/div[1]/ul[1]/li[2]/button[1]"));
        clickP.click();
    }*/
